...
pdf("/Users/sam/Desktop/VAE/derv.pdf", height = 6, width = 8)
...
pdf("/Users/sam/Desktop/VAE/norm.pdf", height = 6, width = 8)
...
pdf("/Users/sam/Desktop/VAE/norm2.pdf", height = 6, width = 8)
...
pdf("/Users/sam/Desktop/VAE/latentspace.pdf", height = 6, width = 8)
par(mfcol = c(1, 1))
...
pdf("/Users/sam/Desktop/VAE/mean.pdf", height = 6, width = 8)
par(mfcol = c(1, 1))
plot(Time, Y[1:T], ylim = c(min(Min[1], Min[2]), max(Max[1], Max[2])), ylab = "Latent Space", xlim = c(min(NewTimes), max(NewTimes)), pch = 16)
points(Time, Y[(T + 1):(2 * T)], col = 2, pch = 16)
...
pdf("/Users/sam/Desktop/VAE/2dls.pdf", height = 6, width = 8)
...
pdf("/Users/sam/Desktop/VAE/2dmean.pdf", height = 6, width = 8)
plot(Y[1:T], Y[(T + 1):(2 * T)], xlab = "X", ylab = "Y", ylim = c(Min[2], Max[2]), xlim = c(Min[1], Max[1]), pch = 16)
