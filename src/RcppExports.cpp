...
// lmcGP_Rcpp
Rcpp::List lmcGP_Rcpp(Rcpp::List DatObj_List, Rcpp::List HyPara_List, Rcpp::List MetrObj_List, Rcpp::List Para_List, Rcpp::List McmcObj_List, arma::mat RawSamples, bool Interactive, bool Verbose);
RcppExport SEXP _dependentGP_lmcGP_Rcpp(SEXP DatObj_ListSEXP, SEXP HyPara_ListSEXP, SEXP MetrObj_ListSEXP, SEXP Para_ListSEXP, SEXP McmcObj_ListSEXP, SEXP RawSamplesSEXP, SEXP InteractiveSEXP, SEXP VerboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type Verbose(VerboseSEXP);
    rcpp_result_gen = Rcpp::wrap(PredY(NKeep, NVisitsReturn, K, Gamma, T, Phi, TimeDist, KernInd, OriginalVisits, NewVisits, NNewVisitsReturn, NOriginalReturn, WhichOriginalReturnLong, WhichOriginalReturn, WhichNewReturn, A, AInd, Sigma2, NVisits, Verbose));
    return rcpp_result_gen;
END_RCPP
}
// PredDerv
Rcpp::List PredDerv(int NKeep, int NNewVisits, int K, arma::mat Phi, arma::mat Sigma2, arma::mat A, arma::uvec AInd, int N, arma::mat IndecesOrg, arma::colvec Time, arma::mat IndecesNew, arma::colvec Y, arma::colvec TimesSort, bool Verbose);
RcppExport SEXP _dependentGP_PredDerv(SEXP NKeepSEXP, SEXP NNewVisitsSEXP, SEXP KSEXP, SEXP PhiSEXP, SEXP Sigma2SEXP, SEXP ASEXP, SEXP AIndSEXP, SEXP NSEXP, SEXP IndecesOrgSEXP, SEXP TimeSEXP, SEXP IndecesNewSEXP, SEXP YSEXP, SEXP TimesSortSEXP, SEXP VerboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type NKeep(NKeepSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type Verbose(VerboseSEXP);
    rcpp_result_gen = Rcpp::wrap(PredDerv(NKeep, NNewVisits, K, Phi, Sigma2, A, AInd, N, IndecesOrg, Time, IndecesNew, Y, TimesSort, Verbose));
    return rcpp_result_gen;
END_RCPP
}
// Play
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_dependentGP_lmcGP_Rcpp", (DL_FUNC) &_dependentGP_lmcGP_Rcpp, 8},
    {"_dependentGP_PredY", (DL_FUNC) &_dependentGP_PredY, 20},
    {"_dependentGP_PredDerv", (DL_FUNC) &_dependentGP_PredDerv, 14},
